...
- **Seed color:** `#8839ef` (used to derive `ColorScheme` via `ColorScheme.fromSeed` where applicable).
...
Import tokens via `package:cartmates/src/theme/theme_constants.dart`.
