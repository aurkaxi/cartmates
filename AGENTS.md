# Agent guide — cartmates

## Project

**cartmates** — Group buying platform exclusively for ONE SINGLE CAMPUS

Generated by [FlutterInit](https://flutterinit.com). Package: `com.example.cartmates`.
...
- Primary import barrel: `package:cartmates/src/imports/imports.dart`.
